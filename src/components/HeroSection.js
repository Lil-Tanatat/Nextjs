  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col lg:flex-row items-center px-4 md:px-8">
        ...
        >
          <h1 className="text-[32px] md:text-[48px] lg:text-[64px] font-medium leading-snug">
            The <span className="text-[#517008]">Giver</span> Token
          </h1>
          <p className="text-[14px] md:text-[18px] lg:text-[20px] font-normal mt-4 md:mt-6">
            is a digital token used for carbon credit trading on the{" "}
          ...
          <p className="text-[14px] md:text-[18px] lg:text-[20px] font-normal mt-2 md:mt-4">
            It aims to make transactions more efficient, secure, and
            eco-friendly by shifting from paper-based to digital processes.
          </p>
          <p className="text-[14px] md:text-[18px] lg:text-[20px] font-normal mt-2 md:mt-4">
            Giver leverages blockchain and smart contracts to ensure
            transparency and connect carbon credit buyers with sellers easily.
          </p>
        ...
        >
          <img src={HeroCO2} alt="Giver Token" className="w-full h-auto" />
        </motion.div>
      </div>
    </section>
  );
